      ...
      <div className="reveal-child relative rounded-3xl overflow-hidden border border-border bg-foreground text-background p-10 md:p-16 glow-ring">
        ...
        <div className="relative grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-4 flex flex-col gap-3">
            <Link to="/contact" className="btn-shine group inline-flex items-center justify-center gap-2 h-14 px-7 rounded-full font-semibold text-sm text-white"
                  style={{ background: "hsl(var(--accent-blue))", boxShadow: "0 20px 40px -10px hsl(var(--accent-blue) / 0.5)" }}>
              Start a Project
              <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
            </Link>
            <Link to="/contact" className="inline-flex items-center justify-center gap-2 h-14 px-7 rounded-full font-semibold text-sm text-white border border-white/20 hover:bg-white hover:text-foreground transition-colors">
