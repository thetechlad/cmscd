...
type Mega = null | "services" | "work" | "industries" | "company";
...
const WORK_ITEMS: NavLink[] = [
  { label: "AI Travel Planning Platform", to: "/work/ai-travel-planning-platform" },
  { label: "Lead Intelligence SaaS", to: "/work/lead-intelligence-saas" },
  { label: "AI Job Application Assistant", to: "/work/ai-job-application-assistant" },
  { label: "Student Visa Operations CRM", to: "/work/student-visa-operations-crm" },
  { label: "Retail Theft Detection System", to: "/work/retail-theft-detection-system" },
  { label: "AI Commerce Builder", to: "/work/ai-commerce-builder" },
];
    ...
    >
      <div
        className={`nav-pill mx-auto flex items-center justify-between gap-2 transition-all duration-300 ${
          scrolled ? "max-w-[1000px] h-14 pl-4 pr-2" : "max-w-[1140px] h-16 pl-5 pr-2"
        }`}
      >
