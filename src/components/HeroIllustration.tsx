const HeroIllustration = () => (
  <svg viewBox="0 0 520 520" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    {/* connecting lines */}
    <g stroke="#2563EB" strokeOpacity="0.35" strokeWidth="1.2" strokeDasharray="3 4">
    ...
    <g filter="url(#shadow)">
      ...
      <rect x="74" y="234" width="50" height="14" rx="4" fill="#2563EB" />
    </g>

    {/* node 2 - code block */}
    <g filter="url(#shadow)">
      <rect x="200" y="80" width="180" height="100" rx="14" fill="url(#grad-soft)" stroke="#E5E7EB" />
      <rect x="216" y="100" width="60" height="6" rx="3" fill="#2563EB" />
    ...
    <g filter="url(#shadow)">
      ...
      <polyline points="356,260 380,240 404,250 428,220 452,232 472,210" fill="none" stroke="#2563EB" strokeWidth="2.5" />
      <circle cx="472" cy="210" r="4" fill="#2563EB" />
    </g>
    ...
    <g filter="url(#shadow)">
      ...
      <path d="M179 334 l4 4 l8 -8" stroke="#2563EB" strokeWidth="2" fill="none" strokeLinecap="round" />
      <rect x="206" y="324" width="56" height="6" rx="3" fill="#0A0A0A" />
      <rect x="206" y="336" width="40" height="5" rx="2.5" fill="#9CA3AF" />
    </g>

    {/* floating dots */}
    <circle cx="80" cy="100" r="4" fill="#2563EB" opacity="0.3" />
    <circle cx="450" cy="380" r="6" fill="#2563EB" opacity="0.25" />
